...
//			GlobalsRevSlider::$urlCaptionsCSS = self::$url_plugin."rs-plugin/css/captions.php";
		...
		/*
                ...
                public static function enqueue_file_uploader_scripts(){
                    ...
                    wp_enqueue_style('jquery-uploadify-css' , self::$url_plugin ."rs-plugin/fileuploader/uploadifive.css");                    
                    ...
                    wp_enqueue_script('jquery-uploadify',self::$url_plugin .'rs-plugin/fileuploader/jquery.uploadifive.js');

                    wp_enqueue_script('jquery-ui-custom',self::$url_plugin .'js/jquery-ui/jquery-ui-1.10.3.custom.js');
